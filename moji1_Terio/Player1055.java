public class Player1055 extends Player {
	...
	private static String name = "バグ野久作";
	private static String url = "https://www.aozora.gr.jp/cards/000096/files/2093_28841.html";
	...
	public String say() {
		String[] messages = {
				"…………ブウウ――――――ンンン――――――ンンンン………………。\n",
				"バグ太郎とは兄弟なんだ☆\n",
				"……アッハッハッハッハッ。ナアーンだ馬鹿馬鹿しい。名前なんてどうでもいいじゃないか。\n忘れたってチットモ不自由はしない。俺は俺に間違いないじゃないか。アハアハアハアハアハ………。\n",
				"ハハン……あまり有り難くないナ……ムニャムニャムニャムニャムニャ………………",
	...
	public static void main(String[] args) {
		Player1055 player = new Player1055();
