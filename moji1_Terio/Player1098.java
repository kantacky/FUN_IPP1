/*public class Player1098 extends Player {
	...
	private static String name = "ヨネグ";
	private static String url = "https://www.aozora.gr.jp/cards/000148/files/752_14964.html";
	...
	public Tango followTango(String word) {
		...
		for(Tango t: super.dicword) {
			...
			if(word.charAt(word.length()-1) == t.getKana().charAt(0) && t.getKana().charAt(t.getKana().length()-1) != 'ん') {
				if(Manager.usedTangos != null) {
					for(String s: Manager.usedTangos) {
						if(s == t.getKana()) {
							continue;
						}
					}
	...
	public static void main(String[] args) {
		Player1098 player = new Player1098();
		String test = 
...
public class Player1098 extends Player {
	...
	// TODO 自分でつけた任意のチーム名，青空文庫のURLを設定してください．以下の例に上書きしてください．
	private static String name = "yonegu";
