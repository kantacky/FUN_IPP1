public class Player1019 extends Player {

	// TODO 自分でつけた任意のチーム名，青空文庫のURLを設定してください．以下の例に上書きしてください．
	private static String name = "チーム大塚ネコ太郎";
	private static String url = "https://www.aozora.gr.jp/cards/000148/files/789_14547.html";
	...
	public Tango followTango(String word) {
		 ...
		 * t.getKana().charAt(t.getKana().length()-1) != 'ん' &&
		 * t.getKana().length() > 1) {
	...
	public static void main(String[] args) {
		Player1019 player = new Player1019();
