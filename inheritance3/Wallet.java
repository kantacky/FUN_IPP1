...
public class Wallet {
  ...
  public int getTotalCommonPoint() {
    ...
    for (Object o : this.cards)
      if (o instanceof PrepaidPointCard) {
        PrepaidPointCard c = (PrepaidPointCard) o;
        total += c.getCommonPoint();
      }
  ...
  public int getTotalAbcPoint() {
    ...
    for (Object o : this.cards)
      if (o instanceof PrepaidPointCardABC) {
        PrepaidPointCardABC c = (PrepaidPointCardABC) o;
        total += c.getAbcPoint();
      }
